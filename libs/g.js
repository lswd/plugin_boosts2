...
{
    cc.log("g.setGlobalInstance" , obj)
    if(name)
    {
        _G[name] = obj;
    }else{
...
g._dumpBuffer = function(res,level)
{
    ...
    for(var r in res)
    {
        ...
        else
        {
            ...
            if(v == "[object Object]")
            {
                cc.log(cc.js.formatStr(pre +"[%s] : " , r));
                ...
                if (v !=null)
                    cc.log(pre + cc.js.formatStr("[%s] : %s ", r,v ));
            }
        }
    }
};
...
{
    color = color || "#0092c3"
    cc.log("%c | "+str+" |", "background-color: "+color+"; background-image: -webkit-linear-gradient(top, "+color+", #eee); background-image: linear-gradient(to bottom, "+color+", #eee); padding: 5px 10px; color: #333");
};
...
cc.Component.prototype.log = function(){
    if(cc.sys.isMobile){
        ...
        cc.log("%c"+ Date.now() +":","border:1px solid green;padding: 5px;", ...arguments,this);
    }
}
...
cc.Component.prototype.warn = function(){
    if(cc.sys.isMobile){
        ...
        console.warn("%c"+ Date.now() +":","border:1px solid orange;padding: 5px;", ...arguments,this);
    }
}
...
cc.Component.prototype.error = function(){
    if(cc.sys.isMobile){
        ...
        console.error("%c"+ Date.now() +":","border:1px solid red;padding: 5px;", ...arguments,this);
    }
}
...
// 0-1
cc.Animation.prototype.stepTo = function(percent,anim_name)
{
